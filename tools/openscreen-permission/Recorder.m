...
@interface RecorderDelegate : NSObject <NSApplicationDelegate, SCRecordingOutputDelegate, SCStreamDelegate>
...
- (void)startRecording {
  WriteStatus(@"requesting-screen-content");
...
int main(int argc, const char *argv[]) {
  ...
  @autoreleasepool {
    ...
    RecorderDelegate *delegate = [[RecorderDelegate alloc] init];
