...
All notable changes to Loci will be documented here.
...
- Initial beta packaging flow.
- Native macOS app with Grid, Canvas, Infinity, X bookmark sync, local API, browser extension capture, document extraction, graph, vault, telemetry controls, and optional LLM workflows.
